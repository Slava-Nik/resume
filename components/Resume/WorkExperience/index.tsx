...
// const jobsData = [
//     {
//         title: 'Startup: Acroplia',
//         country: 'United States (Remote)',
//         dates: 'March 2022 - Nov 2022',
//         position: 'Front-end technical lead & Node.js developer',
//         job_description: 'Acroplia is an extensive and feature-rich communication, collaboration, and community platform for teams, families, and online learning.'
//     }
// ];
...
const WorkExperience = () => {
    return (
        <div className={styles['section']}>
            <h3 className={styles['section-title']}>Work experience / Oct 2015 — present</h3>
            ...
            <div className={styles['jobs']}>
                <div className={styles['job']}>
                    ...
                    <ul className={styles['job__task-list']}>
                ...
                <div className={cn(styles['job'], styles['job--underlined'])}>
                    ...
                    <ul className={styles['job__task-list']}>
                        ...
                        <li>Successfully implemented and delivered the monetization part of Good Gantt:
                            <ul className={styles['job__task-list--nested']}>
