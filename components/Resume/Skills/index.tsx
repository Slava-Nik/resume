        ...
        <div className={cn(styles.skills, 'section')}>
            ...
            <div className={styles['skills-module']}>
                ...
                <List>
                    ...
                    <li>I use SСSS/Stylus with Flexbox, CSS grid, Styled components, CSS modules, Material UI, Ant Design, Bootstrap;</li>
                    <li>Storybook;</li>
                    <li>Adapting websites for mobile devices;</li>
                    <li>Email layout;</li>
                    <li>PWA;</li>
                    <li>SPA development with React.js + Redux (thunk, saga, redux-toolkit), GraphQL, including SSR (Next.js);</li>
                    ...
                    <li>Loading and rendering performance optimizations, data normalization, smooth interfaces;</li>
            ...
            <div className={styles['skills-module']}>
                ...
                <List>
                    ...
                    <li>Cloud Platforms: AWS (EC2, Elastic Load Balancer, AutoScaling group, EBS/EFS, RDS, ElastiCache, Route 53, Lambda, S3, SES), Heroku;</li>
            ...
            <div className={styles['skills-module']}>
                ...
                <List>
                    <li>Languages: English (Fluent/C1), Russian (Native), Ukrainian;</li>
